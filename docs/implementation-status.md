...
- 重製中的主樹保留次枝、末梢枝與十六組資料葉冠，每組使用三張交叉透明葉簇面片，共 48 張；資產為 97 個網格物件、10,119 個頂點及 16,786 個三角面。第三輪加入主枝低頻搖動、葉簇材質微風、程序瀑布流紋與不到一度的相機呼吸環繞；降低動態會恢復主枝／相機原位並停止材質時間。Unity 11／11 測試通過，另保存三秒真實 Unity 影格預覽。畫面仍未完成主枝剪影、石塊構圖、水霧／粒子、後製、六階段成長與真機效能，因此不得建立合併請求，詳見[證據紀錄](leadership-evidence/life-tree-floating-world-evidence.md)。
