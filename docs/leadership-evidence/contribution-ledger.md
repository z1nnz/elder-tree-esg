...
### 2026-08-31：生命樹庭園 iOS 原生串接

- 主要負責人 `@z1nnz` 決定並整合 Flutter／Unity 邊界、後端固定紀念掛點、iOS 原生通道、可回退二維生命樹與可重建 ARM64 框架流程。
- [建置雜湊、測試、問題修正與未完成實機界線](life-tree-mobile-integration-evidence.md)可重現本階段工作；分支為 `codex/life-tree-mobile-integration`，合併狀態以後續合併請求為準。
- 不推定 Android Unity、實體 iPhone 操作、手機效能、最終美術或真實使用者成效已完成。

### 2026-09-10：世界樹與單島雲境外觀精修（開發中）

- 主要負責人 `@z1nnz` 決策：以提供的世界樹插畫為視覺方向，保留單一主島，先完成外觀展示；人物與獨立小鎮玩法延後。
- 主要負責人開發與整合範圍：可重建 Blender 母稿、細葉樹冠、貼合岩壁的盤根、島面林地、三維雲海與遠海、瀑布材質，以及沒有建設卡片遮擋的獨立 Unity 外觀展示場景。
- 原始版本：[提交 5336241](https://github.com/z1nnz/elder-tree-esg/commit/53362416d2df6c2870072aa8bf2921b33d9156e9)、[草稿合併請求 #54](https://github.com/z1nnz/elder-tree-esg/pull/54)。本筆記錄時尚未合併至 `main`。
- [母稿、實際渲染與驗收紀錄](世界樹外觀精修-2026-09-10.md)：Unity 31 項測試、Blender 4 項驗證通過；不以測試數量代表已達參考圖的美術品質。
- 桌面展示程式打包因磁碟空間不足而失敗；僅移除本輪 144 MB 未完成打包產物，保留原始模型、程式、截圖與舊試玩版。未完成手機效能、最新版 App 實機或主要負責人親自操作驗收；外觀仍須繼續精修。
- 後續外觀續修：分離溪流／瀑布消散規則、短白沫水束與雲層輪廓差異，保留同尺寸前後圖及四張連續實景。上述驗收文件續章保存最新 33 項 Unity 測試結果；未重新打包 App、未新增人物或小鎮，也未將美術標為定稿。版本延續草稿 #54。
